...
import { VOLLEYBALL } from '../shared/volleyballleagueinfo'
...
class Volleyball extends Component {
    ...
    render() {
        ...
        const base = this.state.volleyballs.map(volleyball => {
            return(
                    <React.Fragment>                      
                            <Card className='sport_card m-2'>
                            <CardTitle ><h2 className='sport_card_title mt-1 ml-2'>{volleyball.name}</h2></CardTitle>
                                <div className='row'>
                                <div className='col-5 mb-2 mt-2 ml-2'>
                                    <CardImg className='image_for_sport'src={volleyball.image}></CardImg>                                    
                                 ...
                                 <h5 className='rules_title'>Leagues</h5>
                                    <hr/>
                                        {volleyball.groups.map(registration => 
                                    ...
                                    <hr/>
                                        {volleyball.registration.map(registration => 
                                        <li className='rules_list'>
                                            {registration}                           
                                        </li>)}  
                                    <hr/>  
