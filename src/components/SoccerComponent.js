...
import { SOCCERINFO } from '../shared/soccerleagueinfo'
...
class Soccer extends Component {
    ...
    render() {
        ...
        const base = this.state.soccers.map(soccer => {
            return(
                    <React.Fragment>                      
                            <Card className='sport_card m-2'>
                            <CardTitle ><h2 className='sport_card_title mt-1 ml-2'>{soccer.name}</h2></CardTitle>
                                <div className='row'>
                                <div className='col-5 mb-2 mt-2 ml-2'>
                                    <CardImg className='image_for_sport'src={soccer.image}></CardImg>                                    
                                 ...
                                 <hr/>
                                    {soccer.registration.map(registration => 
