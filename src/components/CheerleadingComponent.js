...
import { CHEERLEADING } from '../shared/cheerleadinginfo'
...
class Cheerleader extends Component {
    ...
    render() {
        ...
        const base = this.state.cheerleading.map(cheerlead => {
            return(
                    <React.Fragment>                      
                            <Card className='sport_card m-2'>
                            <CardTitle ><h2 className='sport_card_title mt-1 ml-2'>{cheerlead.name}</h2></CardTitle>
                                <div className='row'>
                                <div className='col-5 mb-2 mt-2 ml-2'>
                                    <CardImg className='image_for_sport'src={cheerlead.image}></CardImg>                                    
                                    <CardBody className='body_description'>
                                        {cheerlead.description}
                                        <Card className='mt-5'>                                    
                                 ...
                                 <h5 className='rules_title'>Additional Information</h5>
                                 <hr/>
                                 <CardBody className='body_description'>
                                        {cheerlead.description2}
                                 </CardBody>
                                    <hr/>  
                                    <h5 className='rules_title'>Rules</h5>
                                    <hr/>
                                    {cheerlead.rules.map(eq => 
                                    <li className='rules_list'>
                                        {eq}                           
                                    </li>)}
                                    <hr/> 
                                    <h5 className='rules_title'>Contact Us</h5>
                                    <hr/>
                                    <CardBody className='body_description'>
                                        {cheerlead.contact}
                                    </CardBody>                                
